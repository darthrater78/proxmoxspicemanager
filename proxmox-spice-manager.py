...
class ProxmoxSpiceManager(tk.Tk):
                ...
                if 0 <= idx < len(self._display_columns) and self._display_columns[idx] != "check":
                    if not hasattr(self, "_heading_tip") or not self._heading_tip or not self._heading_tip.winfo_exists():
                        ...
                        lbl = tk.Label(
                            ...
                            fg=C["subtext0"], font=("sans-serif", 8), padx=6, pady=2,
                        )
                        lbl.pack()
    ...
    def _show_filter_popup(self, col_name, x, y):
        ...
        title = tk.Label(
            ...
            fg=C["subtext0"], font=("sans-serif", 9, "bold"), anchor="w",
        )
        ...
        if col_name == "name":
            ...
            entry = tk.Entry(
                ...
                insertbackground=C["text"], relief="flat", font=("monospace", 10),
            )
            ...
            combo = ttk.Combobox(
                ...
                state="readonly", font=("sans-serif", 10), width=20,
            )
        ...
        if col_name in self._active_filters:
            HoverButton(
                ...
                hover_bg=C["red"], hover_fg=C["crust"], font=("sans-serif", 9),
            ).pack(side="left")
        ...
        if self._active_filters:
            HoverButton(
                ...
                hover_bg=C["surface2"], hover_fg=C["text"], font=("sans-serif", 9),
            ).pack(side="right")
    ...
    def _update_heading_labels(self):
        ...
        heading_font = tkfont.Font(family="sans-serif", size=9, weight="bold")
